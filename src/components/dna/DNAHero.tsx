            ...
            >
                ...
                <div className="relative z-10 w-full flex flex-col items-center justify-center text-center">
                    <motion.div
                        ...
                        className="p-6 md:p-8 rounded-[2.5rem] bg-white/5 backdrop-blur-xl border border-white/10 shadow-[0_0_50px_-12px_rgba(34,211,238,0.3)] w-full max-w-4xl mx-auto"
                    >
                        ...
                        <h2 className="text-xl md:text-2xl font-medium text-idan-david-aviv-gold tracking-wide drop-shadow-[0_0_8px_rgba(212,175,55,0.4)]">
            ...
            <div className="mt-12 md:mt-20 w-full max-w-4xl px-4 text-center z-10 relative">
                <p className="text-idan-david-aviv-gold/90 text-lg md:text-xl font-light leading-relaxed">
                    ...
                    <span className="hidden md:block">
                        Designed for large-scale codebases - Virgo acts as a universal context management codex.<br />
