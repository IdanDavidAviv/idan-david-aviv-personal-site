...
import { FileText, Headphones, MessageSquareCode, RefreshCcw, Terminal, BrainCircuit, AlertTriangle, TrendingUp } from 'lucide-react'
...
export function ReadingFatigue() {
    return (
        <section className="relative pt-12 md:pt-16 pb-4 md:pb-8 px-6 md:px-12 z-10 max-w-6xl mx-auto">
                    ...
                    <div className="pl-16 md:pl-0 md:w-5/12 md:pl-16 w-full">
                        ...
                        >
                            ...
                            <p className="text-white/90 leading-relaxed font-light relative z-10 text-lg">
                                <span className="text-white font-medium drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]">Reading</span> long plans is no  longer required. Reviewing the plans by <span className="text-white font-medium drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]">listening to the agent&apos;s strategy</span> keeps you in the loop. The AI Agent becomes a true conversational collaborator.
                            </p>
                        </motion.div>
                    </div>
                </motion.div>
            </div> {/* End of Timeline Spine Container */}

            {/* Phase 4: The Bottom Line Capstone */}
            <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, margin: "-10px" }}
            ...
            >
                <div className="w-full text-center relative max-w-2xl mx-auto flex flex-col items-center">
                    ...
                    {/* The Card - Shrink-wrapped around the first part */}
                    <div className="inline-flex flex-col items-center text-center py-10 px-8 md:px-12 rounded-3xl border border-emerald-500/10 bg-black/40 shadow-[0_0_15px_rgba(16,185,129,0.1)] group-hover:border-emerald-500/30 transition-all duration-300 backdrop-blur-md relative z-20 overflow-hidden glass-card max-w-xl mx-auto mt-0 w-full">
